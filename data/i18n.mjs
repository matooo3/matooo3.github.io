...
export const projectTranslations = {
  ...
  'matooo3/zero-shot-cxr-vlm': { description: 'A research project exploring chest X-ray classification with vision-language models and different prompting strategies.' },
  'matooo3/codex-ui': { description: 'A personal web interface for AI-assisted development workflows.' },
  ...
  'zaryar/AquaDefender': { description: 'A collaborative top-down 2D game about defending your base.' },
  'matooo3/hockey-env': { description: 'A hockey game environment for experimenting with learning agents in a reinforcement learning course.' },
  'eifelnex/Hands-On-3D-Vision': { description: 'Practical, collaborative work in three-dimensional computer vision.' },
